...
class TestGetHumanAge:
    def test_should_be_equal_zero(self):
        # if age less than 15
    ...
    def test_should_be_equal_one(self):
        # if animal age less than summ first year and second year but more than first year
        assert get_human_age(17, 17) == [1, 1]
        assert get_human_age(18, 2) == [1, 0]
        assert get_human_age(19, 23) == [1, 1]
        assert get_human_age(2, 23) == [0, 1]

    def test_should_be_result_function(self):
    ...
    def test_should_type_error(self):
