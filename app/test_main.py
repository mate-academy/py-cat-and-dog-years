...
class TestGetHumanAge:
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(14,
                         14,
                         [0, 0],
                         id="first 15 cat or dog"
                            " years give 1 human year"),
            pytest.param(15,
                         15,
                         [1, 1],
                         id="the next 9 cat or dog"
                            " years give 1 more human year"),
            pytest.param(28,
                         28,
                         [3, 2],
                         id="every 4 next cat"
                            " years give 1 extra human year"),
            pytest.param(100,
                         100,
                         [21, 17],
                         id="every 5 next dog"
    ...
    def test_get_human_age_correct_types(self,
                                         cat_years: int,
                                         dog_years: int,
                                         expected_years: list) -> None:
        with pytest.raises(expected_years):
