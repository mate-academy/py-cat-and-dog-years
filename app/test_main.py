...
def test_should_raise_type_error_when_one_of_ages_are_string() -> None:
...
def test_should_return_zeros_when_age_is_negative() -> None:
    assert get_human_age(-5, -2) == [0, 0]


def test_should_return_zero_when_ages_are_too_big() -> None:
