...
def test_when_current_year_less_than_first_year() -> None:
    assert get_human_age(14, 14) == [0, 0]


def test_when_current_year_equal_first_year() -> None:
...
def test_when_current_years_greater_than_subtract_and_divide() -> None:
    assert get_human_age(28, 28) == [3, 2]


def test_if_current_year_unusually_large() -> None:
