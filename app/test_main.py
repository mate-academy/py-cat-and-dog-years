...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(0, 0, [0, 0], id="test should return "
                                      "zero age human if age animal zero"),
        pytest.param(14, 14, [0, 0], id="test should return "
                                        "zero age human if animal is young"),
        ...
        pytest.param(28, 28, [3, 2], id="test should return "
                                        "different years"),
        pytest.param(100, 100, [21, 17], id="test should return "
                                            "different years")
    ]
)
