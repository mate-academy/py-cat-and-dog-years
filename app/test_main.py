...
def test_get_human_age_under_fifteen_cat_and_dog():
    """Tests conversion for cat and dog ages under 15."""
    assert get_human_age(14, 14) == [0, 0]


def test_get_human_age_fifteen_cat_and_dog():
    """Tests conversion for cat and dog ages of 15."""
    assert get_human_age(15, 15) == [1, 1]


def test_get_human_age_over_fifteen_but_under_twentyfour_cat():
    """Tests conversion for cat age between 15 and 24 (inclusive)."""
    assert get_human_age(23, 23) == [1, 1]


def test_get_human_age_over_twentyfour_cat():
...
def test_get_human_age_large_cat_age():
