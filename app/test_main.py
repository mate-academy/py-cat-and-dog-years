...
class TestCatDogAge:
    ...
    @pytest.mark.parametrize(
        ...
        ids=[
            "Negative cat/dog years should raise TypeError.",
            "Too large cat/dog years should raise TypeError.",
        ]
    )
    def test_get_human_age_typeerror(self, cat_age: int, dog_age: int) -> None:
