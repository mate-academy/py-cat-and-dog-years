...
def test_get_human_age_within_second_threshold() -> None:
    assert get_human_age(23, 23) == [1, 1]

def test_get_human_age_at_second_threshold() -> None:
    assert get_human_age(24, 24) == [2, 2]

def test_get_human_age_below_next_increment() -> None:
    assert get_human_age(27, 27) == [2, 2]

def test_get_human_age_start_next_increment() -> None:
    assert get_human_age(28, 28) == [3, 2]

def test_get_human_age_large_ages() -> None:
