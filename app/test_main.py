...
@pytest.mark.parametrize(
    ...
    [
        ...
        (27, 27, [2, 2]),  # Both ages between second threshold and next conversion
...
def test_get_human_age_valid_inputs(cat_age: int, dog_age: int, expected: list[int]) -> None:
...
def test_get_human_age_invalid_data_types(cat_age, dog_age) -> None:
