...
def test_should_return_1_human_years_when_animals_age_between_15_and_23() -> None:
...
def test_should_return_2_human_years_when_animals_years_are_27_28_cat_dog() -> None:
