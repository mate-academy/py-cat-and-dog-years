...
@pytest.mark.parametrize(
    ...
    ids=[
        "0 years should be converted into 0 years",
        "Decimal numbers should be converted into int values",
        "Negative numbers should be converted into zeros",
        "100/100 cat/dog years should be converted into 21/17 human age.",
        "27/28 cat/dog years should be converted into 2 human age.",
        "28/29 cat/dog years should be converted into 3 human age.",
        "14.9 cat/dog years should be converted into 1 human age",
        "15 cat/dog years should be converted into 1 human age."
    ]
)
