...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(100, 100, [21, 17],
                     id="Every 4 next cat years and 5 dog years add 1 extra human year"),
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param("dog", 18, TypeError, id="Test invalid data type, raise exception"),
        pytest.param(18, "dog", TypeError, id="Test invalid data type, raise exception"),
        pytest.param("dog", "dog", TypeError, id="Test invalid data type, raise exception"),
        pytest.param("22", "33", TypeError, id="Test invalid data type, raise exception")
    ]
)
