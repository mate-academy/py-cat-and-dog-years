...
def test_should_return_two_years_when_age_from_24():
    list_of_age = get_human_age(24, 24)

    assert list_of_age == [2, 2]


def test_should_return_cat_years_when_age_is_more_28():
    list_of_age = get_human_age(28, 0)

    assert list_of_age == [3, 0]


def test_should_return_dog_years_when_age_is_more_29():
