...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            29,
            [3, 3],
            id="should return every 5 next dog year in human year"
        ),
        pytest.param(
            15,
            15,
            [1, 1],
            id="should return the next 9 dog and cat years in human year",
        ),
        pytest.param(
            28,
            28,
...
def test_cat_and_dog_years_in_human_years_correctly(
    cat_age: int, dog_age: int, goals: list
) -> None:
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            1,
            TypeError,
            id="should raise error when cat age is a string"
        ),
        pytest.param([1],
                     1,
                     TypeError,
                     id="should raise error when cat age is a list"),
        pytest.param(1,
                     [1],
                     TypeError,
                     id="should raise error when dog age is a list"),
        pytest.param(1,
                     "1",
                     TypeError,
                     id="should raise error when dog age is a string"),
    ],
)
