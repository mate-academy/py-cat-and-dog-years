...
def test_should_check_len_list() -> None:
    cat_age = 20
    dog_age = 20
    check_func_get_human_age = get_human_age(cat_age, dog_age)
...
def test_should_check_zero_human_year() -> None:
    cat_age = 14
    dog_age = 14
    check_func_get_human_age = get_human_age(cat_age, dog_age)
...
def test_should_check_one_human_year() -> None:
    cat_age = 23
    dog_age = 23
    check_func_get_human_age = get_human_age(cat_age, dog_age)
...
def test_should_check_two_human_year() -> None:
    cat_age = 24
    dog_age = 24
    check_func_get_human_age = get_human_age(cat_age, dog_age)

    if second_year <= cat_age < first_year + second_year + each_year_cat:
        assert check_func_get_human_age[0] == 2
    if second_year <= dog_age < first_year + second_year + each_year_dog:
