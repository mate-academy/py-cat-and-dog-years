...
class TestGetHumanAge:
    ...
    def test_should_be_equal_to_zero_when_age_less_then_15(self) -> None:
        result = get_human_age(14, 14)
        assert result == [0, 0]

    def test_should_be_equal_to_1_when_age_less_then_24(self) -> None:
        result = get_human_age(23, 23)
        assert result == [1, 1]

    def test_should_return_different_values_when_age_28(self) -> None:
